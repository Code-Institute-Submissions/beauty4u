...
def contact(request):
    ...
    """
    A view that returns the contact us page and takes
    posted information from contact.js
    ...
    if request.method == "POST":
        ...
        body = render_to_string('home/contact_body.txt', {'name': name,
                                                          'email': email,
                                                          'message': message})
        ...
        try:
            ...
            result = "There was a problem sending your email! \
