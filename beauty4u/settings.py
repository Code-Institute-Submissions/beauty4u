"""
Django settings for beauty4u project.
...
SECRET_KEY = '&k3_zu*7+xd531g&z!()du6skxx_*jvof5k)cx5i%b@ripj-x*'
...
WSGI_APPLICATION = 'beauty4u.wsgi.application'
