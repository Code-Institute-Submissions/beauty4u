...
$(".open-mobile-settings").click(function(){
   ...
   $(".expand-menu").click(function(){
    $(this).siblings(".sub-menu").toggle("slide", {direction: "down"}, 100);

    // Change expand icon on click
    if ($(".expand-icon").children(".fas").hasClass("fa-angle-down")) {
        $(this).children(".expand-icon").children(".fas").removeClass("fa-angle-down").addClass("fa-angle-up");
    }
    else {
        $(".expand-icon").children(".fas").removeClass("fa-angle-up").addClass("fa-angle-down");
